package edu.upc.eetac.dsa.asantamaria.hellowebapp;
...
public class ObtenerNombre extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getContentType() == null)
		{
			...
			RequestDispatcher view = request.getRequestDispatcher("/responder.jsp");
			view.forward(request, response);
		}
		else 
		{
			PrintWriter out = response.getWriter();
			out.println ("Version para consola: Tu nombre es: " + nombre);
		}
